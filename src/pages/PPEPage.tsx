  ...
  return (
    <PageContainer className="min-h-screen bg-gradient-to-br from-white via-white to-white py-8">
      <div className="w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-gradient-to-br from-blue-600 to-blue-800 p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-white/90">Total PPE Items</p>
        ...
        {/* Filters */}
        <div className="bg-[#f8f5ee] backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-[#e1d4b1] mb-8">
        ...
        {/* PPE Items Table */}
        <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-lg border border-[#e1d4b1] overflow-hidden">
          <div className="overflow-x-auto">
            ...
            <thead className="bg-[#f0e9db]">
                <tr>
                  ...
                  <th 
                    className="px-6 py-4 text-left text-xs font-medium text-[#5c4a2a] uppercase tracking-wider cursor-pointer hover:bg-[#e1d4b1]/50 transition-colors whitespace-nowrap"
                ...
                {filteredItems.map((item) => (
                  <tr key={item.id} className="hover:bg-[slate-50/80] transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <div className="text-sm text-[#5c4a2a] max-w-xs truncate" title={item.itemDescription}>
