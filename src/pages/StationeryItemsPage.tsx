...
import { FiEdit, FiTrash2, FiPlus, FiSearch, FiX, FiCheck, FiPackage, FiMapPin, FiTool, FiUser, FiUsers, FiBriefcase, FiBookOpen, FiType } from "react-icons/fi";
...
const StationeryItemsPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (!form.itemName.trim() || form.quantity < 0 || !form.itemLocation.trim() || !form.itemType.trim()) return;
      ...
      <div className="w-full">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
          <div className="mb-4 md:mb-0">
            ...
            <p className="text-slate-600 ml-11">Track and manage office supplies and stationery items</p>
          </div>
          <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="card-surface-dark p-6 rounded-2xl shadow-lg transition-all duration-200">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-slate-800">{stationeryItems.length}</p>
              </div>
          ...
          <div className="card-surface-dark p-6 rounded-2xl shadow-lg transition-all duration-200">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-slate-500 font-medium text-sm">Item Types</h3>
                <p className="text-3xl font-bold text-purple-600">
                  {new Set(stationeryItems.map(item => item.itemType)).size}
                </p>
              </div>
              <div className="p-3 bg-purple-100 rounded-xl">
                <FiType className="w-6 h-6 text-purple-600" />
              </div>
            </div>
          </div>
          <div className="card-surface-dark p-6 rounded-2xl shadow-lg transition-all duration-200">
            ...
            <div className="bg-white rounded-2xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                      placeholder="e.g., Pen, Paper, Folder"
                      required
                    />
                  </div>
                </div>
                ...
                <div className="flex justify-end space-x-4 pt-6 border-t border-slate-200">
                  ...
                  <button
                    type="submit"
                    className="px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-200"
                  >
